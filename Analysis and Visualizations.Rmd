...
register_google(key = "AIzaSyAU1V0uEmoG3Pz3tVXAqYMEjsaGusIfMLQ")
...
# Warning that rows were removed are tickets outside the limits of the map.
# State the limitations of this map
