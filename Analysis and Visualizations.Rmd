...
```{r}
# Import Libraries
x <- c("dplyr", "magrittr", "lubridate", "ggplot2", "fasttime",
...
```{r}
graph_cits(april_cits, "Citations for April 2018", "Day", "Tot_Day_Cits",
           "Day", "# of Citations")
```

```{r}
graph_cits(sept_cits, "Citations for September 2018", "Day", "Tot_Day_Cits",
           "Day", "# of Citations")
```
...
ggplot(cits_by_TOD, aes(x = TOD, y = Total_Cits)) +
  ...
  labs(x = 'Citation Time (Military Time)', y = "Number of Citations",
       title = "Total Citations Across Time By Day") + 
  ylim(0, 1500) +
